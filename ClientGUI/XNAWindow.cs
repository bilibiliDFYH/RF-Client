        ...
        protected virtual void GetINIAttributes(IniFile iniFile)
        {
            ...
            if (keys != null)
            {
                foreach (string key in keys)
                    ParseControlINIAttribute(iniFile, key, iniFile.GetStringValue(Name, key, String.Empty));
            }
            else
            {
                ...
                {
                    foreach (string key in keys)
                        ParseControlINIAttribute(iniFile, key, iniFile.GetStringValue(GENERIC_WINDOW_SECTION, key, String.Empty));
                }
            }
