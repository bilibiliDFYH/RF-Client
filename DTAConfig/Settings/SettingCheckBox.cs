...
namespace DTAConfig.Settings
{
    ...
    public class SettingCheckBox : SettingCheckBoxBase
    {
        ...
        {
            string value = UserINISettings.Instance.SettingsIni.GetValue(SettingSection, SettingKey, string.Empty);
        ...
        {
            if (WriteSettingValue)
                UserINISettings.Instance.SettingsIni.SetValue(SettingSection, SettingKey, Checked ? EnabledSettingValue : DisabledSettingValue);
            else
