...
namespace DTAConfig.Settings
{
    ...
    public class SettingDropDown : SettingDropDownBase
    {
        ...
        {
            if (WriteItemValue)
                SelectedIndex = FindItemIndexByValue(UserINISettings.Instance.SettingsIni.GetValue<string>(SettingSection, SettingKey, null));
            else
                SelectedIndex = UserINISettings.Instance.SettingsIni.GetValue(SettingSection, SettingKey, DefaultValue);
        ...
        {
            if (WriteItemValue)
                UserINISettings.Instance.SettingsIni.SetValue(SettingSection, SettingKey, SelectedItem.Text);
            else
                UserINISettings.Instance.SettingsIni.SetValue(SettingSection, SettingKey, SelectedIndex);
