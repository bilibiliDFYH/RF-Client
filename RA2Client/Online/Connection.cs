...
namespace Ra2Client.Online
{
    ...
    public class Connection
    {
        ...
        private static readonly IList<Server> Servers = new List<Server>
        {
            ...
            new("a-root.ad.cn.ru2023.top","a-root.ad.cn.ru2023.top",[6667]), //RF自用节点1，仅可用于重聚未来客户端
            ...
            new("g-root.yd.orc.ru2023.top","g-root.yd.orc.ru2023.top",[6667]) //RF自用节点5，仅可用于重聚未来客户端

            //---------------自建IRC公共节点，使用前需向重聚制作组报备，后续维护方便我们通知，报备QQ群733393645---------------//

            //new("e-root.public.cn1.ru2023.top","e-root.public.cn1.ru2023.top",[6667]), //YR公共节点1，和重聚自用节点不互通
